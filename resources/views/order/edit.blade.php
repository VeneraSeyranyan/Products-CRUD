        ...
        <div class="row" style="width:500px;background: #c5d78f;">
            <div class="col-xs-12 col-sm-12 col-md-12"  style="width: 250px;margin: 7px;border: 4px; padding: 10px;">
                <div class="form-group">
                    <strong>Qty:</strong>
                    <input type="number" name="qty" value="{{ $order->qty}}"  style="height:50px;width:230px"class="form-control" placeholder="qty">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12" style="width: 150px;margin: 7px;border: 4px; padding: 10px;">
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" style="height:50px;width:100px" name="date_time"  value="{{ $order->order_date_time }}" placeholder="order_date_time">
                </div>
            </div>
